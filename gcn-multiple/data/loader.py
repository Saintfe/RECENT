...
class DataLoader(object):
    ...
    """
    def __init__(self, filename, batch_size, opt, vocab, data_type='training'):
        self.batch_size = batch_size
        self.opt = opt
        self.vocab = vocab
        self.eval = (data_type != 'training')
        self.label2id = constant.LABEL_TO_ID[opt['type_pair_id']]
        ...
        if data_type == 'training':
            ...
            print(self.raw_data[0]['order_id'])
            self.order_ids = [d['order_id'] for d in self.raw_data]
