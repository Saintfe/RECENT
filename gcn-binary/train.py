...
for epoch in range(1, opt['num_epoch']+1):
    ...
    dev_p, dev_r, dev_f1 = scorer.p_r_f1_binary(dev_batch.gold(), predictions)
    print( "Precision (micro): {:.3%}".format(dev_p) )
    print( "   Recall (micro): {:.3%}".format(dev_r) )
    print( "       F1 (micro): {:.3%}".format(dev_f1) )
